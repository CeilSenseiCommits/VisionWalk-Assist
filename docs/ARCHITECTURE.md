...
**VisionGuide-Assist** is an egocentric computer vision perception and spatial guidance system designed for individuals with visual impairments. Powered by the **[AutoDoor-DataEngine](https://github.com/CeilSenseiCommits/AutoDoor-DataEngine)** automated VLM visual harvesting and dataset generation engine, the system solves three primary spatial navigation challenges:
